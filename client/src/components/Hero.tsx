  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto relative w-full">
        <div className="max-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative">
          <div >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 animate-in slide-in-from-bottom duration-700 delay-300">
              <button className="group px-6 gap-1 sm:px-8 py-3 sm:py-4 bg-primary text-white font-semibold rounded-lg front-semibold text-sm transition-all duration-300 hover:scale-102 flex items-center justify-center space-x-2 cursor-pointer">
                Get a Free Estimate
